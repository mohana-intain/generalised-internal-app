...
function setChaincodePath(){
	...
	case "$LANGUAGE" in
		"golang")
		CC_SRC_PATH="github.com/UserCC/go"
		;;
		"node")
		CC_SRC_PATH="$PWD/artifacts/src/github.com/UserCC/node"
		;;
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/$Cname?peer=peer0.org1.example.com&fcn=query&args=%5B%22a%22%5D" \
